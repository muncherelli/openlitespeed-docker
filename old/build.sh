...
if docker build --no-cache -f docker/Dockerfile -t ${REPO_OWNER}/openlitespeed:$TAG --build-arg OPENLITESPEED_VERSION=$OPENLITESPEED_VERSION --build-arg PHP_VERSION=$PHP_VERSION . ; then
